  ...
  return (
    <main>
      ...
      <div className="flex-grow p-4">
        ...
        <Wrapper title="Horizontal Detail User Card" className="flex">
          <UserCard>
            <dl className="detail horizontal">
              <dt className="avatar-container read-only">Avatar</dt>
              <dd className="avatar-container">
                <Avatar circle={true} size={24} className="stroke border-secondary-50">
                  <img src="http://daisyui.com/tailwind-css-component-profile-1@96w.png" />
                </Avatar>
              </dd>
              <dt className="read-only">Nombre</dt>
              <dd className="user-card-name">Benoit Lafalletye</dd>
              <dt className="read-only">email</dt>
              <dd className="user-email">
              ...
              <dt className="small">Cumpleaños</dt>
              <dd className="user-birthday">
                04 de Junio (14 años) {/* TODO HACER ICONO */}
                <svg
                  width="17"
                  height="16"
                  viewBox="0 0 17 16" 
